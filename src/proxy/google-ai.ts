 ...
 * Redirects gemini-2.5-pro-exp-03-25 to gemini-2.5-pro-preview-03-25.
 **/
function maybeReassignModel(req: Request) {
  ...
  // Handle specific model redirection
  if (req.body.model === "gemini-2.5-pro-exp-03-25") {
    req.log.info({ requested: req.body.model }, "Redirecting to gemini-2.5-pro-preview-03-25");
    req.body.model = "gemini-2.5-pro-preview-03-25";
    return;
  }
